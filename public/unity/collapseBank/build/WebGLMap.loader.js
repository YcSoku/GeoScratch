function createUnityInstance(t, r, d) {
    ...
    return c.SystemInfo = function () {
    ...
    }, S), c.cachedFetch = (g = c.UnityCache, m = g.RequestStore, b = c.fetchWithProgress, k.prototype.arrayBuffer = function () {
        ...
        function i(e, t) {
            return b(e, t).then(function (e) {
                if (s.enabled && !s.revalidated) {
                    ...
                    200 == e.status ? (s.result = P(e.url, s.company, s.product, s.accessed, e), s.revalidated = !0, a.storeRequest(s.result).then(function () {
        ...
        return o && (s.control = o.control, s.company = o.company, s.product = o.product), s.result = P(r, s.company, s.product, Date.now()), s.revalidated = !1, s.enabled ? a.loadRequest(s.result.url).then(function (e) {
